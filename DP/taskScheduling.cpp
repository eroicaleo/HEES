...
dynProg::dynProg(int numOfTask, double deadline, vector<double> taskDuration, vector<double> taskEnergy) {
	...
	m_taskDuration = vector<vector<double> >(numOfTask, vector<double>(m_numOfVolt, 0.0));
	m_taskEnergy = vector<vector<double> >(numOfTask, vector<double>(m_numOfVolt, 0.0));
	m_scheduleEnergy = vector<vector<double> >(numOfTask, vector<double>((int)m_deadline * 10 + 1 , 0.0));
	m_scheduleVolt =  vector<vector<double> >(numOfTask, vector<double>((int)m_deadline * 10 + 1, 0.0));
	m_lastStepDuration = vector<vector<double> >(numOfTask, vector<double>((int)m_deadline * 10 + 1, 0.0));
